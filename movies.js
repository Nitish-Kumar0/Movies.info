//For adding new items in the menu
const btn = document.getElementById("addbutton");
const newinput = document.getElementById("addresults");
btn.addEventListener('click', function() {

    const newListItem = document.createElement('h4');
    newListItem.textContent = newinput.value;
    const div1 = document.getElementById('addItem');
    if(newinput.value!='')
    div1.appendChild(newListItem);
    newinput.value = '';
  });
  


//For the display of the Movies
const API_KEY = 'aaf72e4965fb691f4185b549bc169961';
...
function displayMovieList(movies) {
    ...
    movies.forEach(movie => {
        ...
        movieItem.innerHTML = `
            ...
            <img class="imag" src="https://image.tmdb.org/t/p/w200${movie.poster_path}"alt="${movie.title}">
        `;
...
function displayMovieDetails(movie) {
    ...
    movieDetails.innerHTML = `
        ...
        <h2>${movie.title}</h2>
        <p class ="Release"><b>Release Date</b>: ${movie.release_date}</p>
